...
<body>	
	...
	<form action="Test" method="post">
		<div class="top">
			<input class="Cal-input" type="number" name="txtnum1" placeholder="Enter First Number" value="<%=a %>" />
			<br> <br>
			<input class="Cal-input" type="number" name="txtnum2" placeholder="Enter Second Number"  value="<%=b %>" /> 
		</div>
		<div class="middle">
